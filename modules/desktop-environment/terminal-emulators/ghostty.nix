    ...
    in {
        ...
        settings = {
            ...
            keybind = [
                ...
                "${mod}+j=goto_split:next"
                "${mod}+k=goto_split:previous"

                "${mod}+r>j=resize_split:down,${resize-step}"
                "${mod}+r>k=resize_split:up,${resize-step}"
                "${mod}+r>h=resize_split:left,${resize-step}"
                "${mod}+r>l=resize_split:right,${resize-step}"
